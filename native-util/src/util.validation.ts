import { DDD_BRASIL } from './consts.general'
import { REGEX_EMAIL, REGEX_PHONE } from './consts.regex'
...
export function validatePhoneNumber(
  ...
  let phone = extractNumbers(phoneNumber)
  ...
  const isValid = REGEX_PHONE.test(phone)

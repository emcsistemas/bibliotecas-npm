  ...
  function numberPress(valuePressed: string) {
    ...
    if (props.maxLength && valuePressed !== "x") {
      if (
        ...
        props.currentFieldValue.length === props.maxLength
      ) {
        Haptics.notificationAsync();
        return;
      }
  ...
  return (
    <>
      ...
      <View style={styles.footerContainer}>
        {props.footerButton && (
          <EMCBox flex={1} bRightColor={EMCColors.gray[300]} bRightWidth={0.5}>
            <TouchableOpacity
              style={{ flex: 1 }}
              activeOpacity={
        ...
        {props.aditionalFooterButton && (
          <EMCBox flex={1} bLeftColor={EMCColors.gray[300]} bLeftWidth={0.5}>
            <TouchableOpacity
              style={{ flex: 1 }}
              activeOpacity={
